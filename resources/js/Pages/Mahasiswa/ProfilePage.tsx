      ...
      <div className="max-w-4xl mx-auto py-8 px-4">
        <div className="space-y-8">
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-[200px_1fr] gap-x-4 items-center">
              <span className={labelClassName}>NIM</span>
            ...
            <div className="grid grid-cols-[200px_1fr] gap-x-4 items-center">
              <span className={labelClassName}>Faculty</span>
              <span className={valueClassName}>{auth.mahasiswa.faculty}</span>
            </div>

            <div className="grid grid-cols-[200px_1fr] gap-x-4 items-center">
              <span className={labelClassName}>Study Program</span>
              <span className={valueClassName}>{auth.mahasiswa.study_program}</span>
            </div>

            <div className="grid grid-cols-[200px_1fr] gap-x-4 items-center">
              <span className={labelClassName}>Current Semester</span>
